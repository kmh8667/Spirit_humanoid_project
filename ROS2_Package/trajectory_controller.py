...
robot_to_sim_idx = {  # real robot order <-> sim order
    "R_hip_yaw_joint": 2,
    "R_hip_roll_joint": 6,
    "R_thigh_joint": 10,
    "R_knee_joint": 13,
...
default_joint_pos = {
    ...
    "R_ankle_joint": 0.5,
    "L_foot_joint": 0.0,
    "R_shoulder_joint": 0.0,
    "R_elbow_joint": 0.0,
    "R_hand_joint": 0.0,
    "L_shoulder_joint": 0.0,
    "L_elbow_joint": 0.0,
    "L_hand_joint": 0.0,
}
...
joint_pos_clip = {
    ...
    "L_shoulder_joint": (-1.57, 1.57),
    "R_hip_yaw_joint": (-0.6, 0.6),
    "R_shoulder_joint": (-1.57, 1.57),
    "L_hip_roll_joint": (-0.1, 0.4),
    "L_elbow_joint": (-1.57, 0.0),
    "R_hip_roll_joint": (-0.4, 0.1),
    "R_elbow_joint": (0.0, 1.57),
    "L_thigh_joint": (-0.78, 0.78),
    "L_hand_joint": (-1.57, 1.57),
    "R_thigh_joint": (-0.78, 0.78),
    "R_hand_joint": (-1.57, 1.57),
    "L_knee_joint": (0.0, 1.57),
    "R_knee_joint": (-1.57, 0.0),
    "L_ankle_joint": (-0.78, 0.78),
    "R_ankle_joint": (-0.78, 0.78),
    "L_foot_joint": (-0.32, 0.32),
    "R_foot_joint": (-0.32, 0.32),
}
...
if __name__ == "__main__":
    ...
    robot_name = "spirit"  # Default robot name
